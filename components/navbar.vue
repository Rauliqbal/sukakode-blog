...
<template>
   <nav class="fixed inset-x-0 z-20 py-4 md:py-6 bg-white shadow-md">
      <div class="container">
         <div class="flex items-center justify-between">
            <div class="relative">
               <NuxtLink to="/">
                  <img class="h-10" src="~/assets/images/sukakode.png" alt="Belajar Pemrograman web dan UI Design yang mudah dipahami" />
               </NuxtLink>
            </div>
